        ...
        <div className={styles.right}>
          ...
          <div className={styles.right_text_container}>
            <div className={styles.summary_text}>
              <span>Total MRP: </span>
              <span className={styles.summary_text_data}>Rs.{cart.totalMRP}</span>
            </div>
            <div className={styles.summary_text}>
              <span>Discount on MRP:</span>
              <span className={styles.discount_data}> Rs.{cart.totalMRP - cart.total}</span>
            </div>
            <div className={styles.summary_text}>
              <span>Shipping Charges:</span>
              {shipping!==0 && (<span className={styles.summary_text_data}>Rs.{shipping}</span>)}
          ...
          <div className={styles.sub_total}>
            ...
            <span className={styles.total_price}>Rs.{cart.total + shipping}</span>
          </div>
